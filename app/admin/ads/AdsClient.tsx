...
const QUICK_PRESETS = [
    {
        label: 'Landing Page', price: '$300 USD', time: '2 semanas', color: '#0066FF',
        ...
        idea: 'Anuncio de Stephano.io para Landing Pages estratégicas desde $300 USD, diseño Liquid Glass de alta conversión, entrega en 2 semanas. Visita stephano.io',
    },
    {
                            ...
                            <tbody>
                                {scheduled.map((ad, i) => (
                                    <tr key={ad.id}>
                                        ...
                                        <td>
                                            <button onClick={async () => { const r = await updateAdStatus(ad.id, 'published'); if (r.success) setAdsList(adsList.map(a => a.id === ad.id ? { ...a, status: 'published' } : a)); }} className={styles.btnPrimary} style={{ fontSize: 12, padding: '6px 14px' }}>
                                                Marcar Publicado
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        <div className={styles.tableCard} style={{ padding: 20 }}>
                            ...
                            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', lineHeight: 1.7 }}>
                                Pipeline de generación activo. Los ads aprobados quedan listos para publicar manualmente.
                            </div>
                        </div>
